    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
          <div id={modalTitleId} className="flex items-center gap-2 font-semibold text-slate-800">
        ...
        <div className="px-6 py-6 flex flex-col items-center gap-4">
          {adBeforeDownload && !canDownload ? (
            <>
              ...
              <p id={modalDescId} className="text-slate-600 text-sm text-center">
            ...
            <div className="flex flex-col items-center gap-3 py-2">
              ...
              <p id={modalDescId} className="text-xs text-slate-500 text-center break-all max-w-xs">
                {fileName}
              </p>
            </div>
          )}
