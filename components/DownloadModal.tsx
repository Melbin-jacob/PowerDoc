...
export default function DownloadModal({ fileName, onDownload, onClose }: DownloadModalProps) {
  ...
  // Adjusting state based on props pattern to avoid lint error
  if (adBeforeDownload !== prevAdBeforeDownload) {
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
          ...
          <button
            ...
            className="p-1 rounded-lg hover:bg-slate-100 text-slate-400 hover:text-slate-600 transition-colors focus-visible:ring-2 focus-visible:ring-blue-500 outline-none"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="px-6 py-6 flex flex-col items-center gap-4">
          ...
          <button
            ...
            className={`w-full py-3 rounded-xl font-semibold text-sm flex items-center justify-center gap-2 transition-all focus-visible:ring-2 focus-visible:ring-blue-500 outline-none ${
              canDownload
